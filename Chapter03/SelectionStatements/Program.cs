...
namespace SelectionStatements
{
    class Program
    {
        ...
        A_label:
            ...
            Stream s = File.Open(Path.Combine(path, "c#testfile.txt"), FileMode.OpenOrCreate);
            ...
            switch(s)
            {
                ...
                case MemoryStream ms:
                    ...
                    break;
                default:
                    message = "The stream is some ther type.";
                    break;
                case null:
            ...
            File.Delete(Path.Combine(path, "c#testfile.txt"));
        }
    }
}
