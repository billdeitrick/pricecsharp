...
namespace LinqWithEFCore
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                //FilterAndSort(db);
                //JoinCategoriesAndProducts(db);
                //GroupJoinCategoriesAndProducts(db);
                AggregateProducts(db);
            }
        }

        static void FilterAndSort(Northwind db)
        {
        ...
        static void JoinCategoriesAndProducts(Northwind db)
        {
        ...
        static void GroupJoinCategoriesAndProducts(Northwind db)
        {
        ...
        static void AggregateProducts(Northwind db)
        {
            WriteLine("{0, -25} {1,10}",
                arg0: "Product count:",
